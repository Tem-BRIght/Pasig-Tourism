...
const Home: React.FC = () => {
  ...
  const profilePic = localStorage.getItem('profilePic') || 'public/assets/images/Temporary.png';
  ...
  const recommended = [
    {
      id: 1,
      image: 'public/assets/images/Pasig Museum.png',
    ...
    {
      id: 2,
      image: 'public/assets/images/Ace Hotel.png',
    ...
    {
      id: 3,
      image: 'public/assets/images/dimas-alang.png',
  ...
  const popular = [
    {
      image: 'public/assets/images/Pasig Cathedral.png',
    ...
    {
      image: 'public/assets/images/Pasig Rainfo.png',
    ...
    {
      image: 'public/assets/images/Pasig Kapitolyo.png',
      title: 'Kapitolyo',
      rating: 4.6,
      reviews: '980',
      distance: '92 km away',
